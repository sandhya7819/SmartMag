...
path = r"C:\Users\SK-0010\.gemini\antigravity-ide\brain\49a3ebdd-d72b-4aeb-94c7-ef2e6e9d702c\.system_generated\steps\100\content.md"
output_path = r"c:\Users\SK-0010\WEBSITE-TEMPLATES\scratch\parsed_lazybusy.txt"
...
for cls, data_id, content in blocks:
    ...
    for art_cls, art_content in articles:
        ...
        if not review_match:
            review_match = re.search(r'<span class="counter[^"]*">(.*?)</span>', art_content, re.DOTALL)
